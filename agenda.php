                      ...
                      <div class="col-12">
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                                    ...
                                    <?php 
                                    $select = "SELECT *FROM servico, cliente INNER JOIN agenda ON agenda.cliente = cliente.idcliente WHERE servico >0  order by data ;";
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="  col-md-12 col-sm-12 pb-4">
                                                ...
                                                echo"<div class='border rounded p-2 shadow-sm'>
                                                    ...
                                                    echo"<div>
                                                            <a class='float-left mt-2' href='status_concluido.php? idagenda=" . $line['idagenda'] . "'><button type='button' class='btn btn-sm'>Marcar como concluído</button></a>
                                                        </div>";
                                                    }
                                                    echo"<div>
                          ...
                          <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
                                <?php 
                                $select = "SELECT *FROM servico, cliente INNER JOIN agenda ON agenda.cliente = cliente.idcliente WHERE servico >0 and situacao_atual = 'Solicitado' ;";
                                $query = mysqli_query($connect, $select);
                                $totalRegistros = mysqli_num_rows($query);
                          ...
                          <div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list"> <?php 
                                $select = "SELECT *FROM servico, cliente INNER JOIN agenda ON agenda.cliente = cliente.idcliente WHERE servico >0 and situacao_atual = 'Concluido' ;";
                                $query = mysqli_query($connect, $select);
                                $totalRegistros = mysqli_num_rows($query);
