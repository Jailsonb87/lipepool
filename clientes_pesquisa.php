...
if (isset($_SESSION["nivel"])){
	...
	include_once("connect.php");
            ...
            $sql = "SELECT * FROM cliente where nivel = 0 and nome LIKE '%$valor_pesquisar%';";
	    $query = mysqli_query($connect, $sql);
            ...
            $result_clientes = "SELECT * FROM cliente where nivel = 0 and nome LIKE '%$valor_pesquisar%' limit $incio, $quantidade_pg";
              ...
              <ul class="pagination pagination pagination-sm justify-content-center ">
                <li class="page-item ">
                    <?php
                            ...
                            <a class="page-link" href="clientes_pesquisa.php?pagina=<?php echo $pagina_anterior; ?>&pesquisar=<?php echo $valor_pesquisar; ?>" aria-label="Previous">
                                        Anterior
                                    </a>
                            <?php }else{ ?>
                ...
                <li class="page-item">
                    <a class="page-link" href="clientes_pesquisa.php?pagina=<?php echo $i; ?>&pesquisar=<?php echo $valor_pesquisar; ?>"><?php echo $i; ?></a>
                </li>
                <?php } ?>
                ...
                <li class="page-item">
                    <?php
                            if($pagina_posterior <= $num_pagina){ ?>
                                    <a class="page-link" href="clientes_pesquisa.php?pagina=<?php echo $pagina_posterior; ?>&pesquisar=<?php echo $valor_pesquisar; ?>" aria-label="Previous">
                                       Próxima
                                    </a>
                            <?php }else{ ?>
                            <li class="page-item disabled">
